...
Blockly.Msg.KF_ANIMATION_HELPURL = "";  // untranslated
Blockly.Msg.KF_ANIMATION_NEXT_FRAME_HELPURL = "";  // untranslated
Blockly.Msg.KF_ANIMATION_NEXT_FRAME_MESSAGE = "goto next animation frame";  // untranslated
Blockly.Msg.KF_ANIMATION_NEXT_FRAME_TOOLTIP = "Goes to the next frame in the current animation. If at the end of an animation it will go to the first frame.";  // untranslated
...
Blockly.Msg.KF_ANIMATION_PAUSE_HELPURL = "";  // untranslated
Blockly.Msg.KF_ANIMATION_PAUSE_MESSAGE = "pause animation";  // untranslated
Blockly.Msg.KF_ANIMATION_PAUSE_TOOLTIP = "Pause the current animation on this gameobject.";  // untranslated
...
Blockly.Msg.KF_ANIMATION_PREV_FRAME_HELPURL = "";  // untranslated
Blockly.Msg.KF_ANIMATION_PREV_FRAME_MESSAGE = "goto previous animation frame";  // untranslated
Blockly.Msg.KF_ANIMATION_PREV_FRAME_TOOLTIP = "Goes to the previous frame in the current animation. If at the start of an animation it will go to the last frame.";  // untranslated
Blockly.Msg.KF_ANIMATION_RESUME_HELPURL = "";  // untranslated
Blockly.Msg.KF_ANIMATION_RESUME_MESSAGE = "resume animation";  // untranslated
Blockly.Msg.KF_ANIMATION_RESUME_TOOLTIP = "Resumes the current animation on this gameobject.";  // untranslated
Blockly.Msg.KF_ANIMATION_TOOLTIP = "A list of all animations the this gameobject can play.";  // untranslated
...
Blockly.Msg.KF_INSTANCE_CLOSEST_HELPURL = "";  // untranslated
Blockly.Msg.KF_INSTANCE_CLOSEST_MESSAGE = "closest instance to me";  // untranslated
Blockly.Msg.KF_INSTANCE_CLOSEST_TOOLTIP = "The closest instance to this gameobject the script is attached to.";  // untranslated
